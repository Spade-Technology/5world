...
function SectionOne() {
  return (
    <section className='mt-9 flex max-w-[1280px] flex-col md:mx-auto md:mt-20'>
      <h1 className='text-4xl font-medium text-vdao-light md:text-8xl'>VDAO Manifesto</h1>
      <h2 className='mt-6 font-heading text-3xl font-medium text-white'>Restoring Ecosystems From the Soil up.</h2>
      <div className='mt-14 flex flex-col-reverse md:flex-row '>
        ...
        <div className='my-auto flex flex-col gap-4 font-body text-xl font-medium leading-7 text-vdao-light md:w-1/2'>
          ...
          <span className='mb-1 inline-flex gap-3'>
            <Image src={Tick} alt='VDAO' width={20} height={20} />
            Follow us on <span className='underline underline-offset-4'>Twitter</span>
          </span>
          <span className='mb-1 inline-flex gap-3'>
            <Image src={Tick} alt='VDAO' width={20} height={20} />
            Join us on <span className='underline underline-offset-4'>Discord</span>
          </span>
          <span className='mb-1 inline-flex gap-3'>
            <Image src={Tick} alt='VDAO' width={20} height={20} />
            <span className='underline underline-offset-[6px]'>Sign up</span> to our mailing list
          </span>
        </div>
      </div>
    </section>
