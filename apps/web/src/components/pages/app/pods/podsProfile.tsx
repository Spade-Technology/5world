    ...
    <Section className='w-full bg-vdao-deep'>
      ...
      <div className='flex flex-col md:flex-row '>
        ...
        <div className='mt-[30px] flex flex-1 flex-col gap-5 pl-6 md:mt-0 md:flex-row lg:pl-16'>
          <PrimaryButton text='Create Pods' onClick={() => (siwe ? setOpenCreatePod(true) : router.push('/app/pods/#restrictedContent'))} 
          className='pt-[1px]  text-xl w-fit' />
          <div className='w-fit cursor-pointer rounded-[5px] border-2 border-white py-[5px] px-[38px] font-heading text-xl text-white'>
