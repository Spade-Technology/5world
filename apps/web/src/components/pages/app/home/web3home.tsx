...
import MainHeroForMobile from '/public/illustrations/web3/SVG/05_welcome_illo_withoutGrain_v01 1 (1).svg'
...
export function StatisticsHomeComponent() {
  ...
  return (
    <Section className=' col-span-12 mb-28 w-full rounded-2xl bg-vdao-dark py-10 lg:py-12 lg:pr-16 lg:pl-12'>
      <div className='grid-cols-12 items-start justify-between md:grid'>
        <div className='mt-[53] md:col-span-6 lg:col-span-7'>
          <div className='mb-[55px] flex items-start justify-between px-5 text-white md:ml-6 md:items-center md:pl-0'>
            <div className='leading-0 font-body text-[22px] font-bold text-white'>Treasury</div>
            <div className='mx-auto flex flex-col gap-2.5 md:ml-0 md:mr-0 md:flex-row md:items-center md:gap-10'>
              <div className='flex h-fit items-center py-0 '>
                <div className='mr-2.5 h-[15px] w-[15px] rounded-full bg-vdao-light'></div>
                <div className='font-body text-sm font-normal text-white md:mt-0 md:leading-10 lg:leading-[18.9px]'>USDC</div>
              </div>
        ...
        <div className='col-span-4 px-5 md:px-0 '>
      ...
      <article className='mt-12 flex flex-col gap-5 px-2.5 md:px-10 lg:flex-row lg:justify-end lg:gap-10'>
      ...
      <section className='mt-[60px] grid-cols-12 items-start justify-between pr-5 md:grid md:pr-0 lg:pr-10 '>
        ...
        <div className='col-span-1'></div>
        <div className='col-span-4 mt-[60px] md:mt-0'>
          <div className='mb-[30px] flex items-center pl-5 text-white md:mb-[35px] lg:mb-0 lg:pl-0'>
  ...
  return (
    <Section className=' col-span-12 w-full justify-between rounded-2xl bg-vdao-dark px-5 py-10 md:flex md:px-10 md:pt-14 md:pb-10 lg:col-span-5 lg:mb-0 lg:block'>
            ...
            return (
              <div className=' flex items-center justify-between md:w-80 lg:w-auto' key={index}>
                <div className='mr-6 flex items-center'>
                  <Image src={member && member.picture ? member.picture : StaticProfilePic} alt='' height={10} width={10} className='mr-4 h-10 w-10 rounded-full' />
                  <div>
      ...
      <div className='xl:px-10'>
        ...
        <article className='custom-scrollbar mt-8 grid max-h-[148px] grid-cols-12 gap-5 overflow-y-auto overflow-x-hidden pr-2 md:mt-5 md:max-h-[263px] lg:mt-[30px] lg:max-h-[168px]'>
          {onlineMembersData.map(({ name, img }, index) => {
            return (
              <div className='col-span-3 w-[50px] overflow-hidden'>
                <img src={img} alt='' className='mx-auto h-10 w-10 rounded-full' />
                <div className='w-[50px] font-body text-sm font-normal text-white md:w-20'>{name}</div>
              </div>
            )
          })}
        </article>
...
export function WelcomeComponent() {
  return (
    <Section className='relative mx-auto flex max-w-[1437px] flex-col items-center md:h-auto md:pt-16'>
      <div className='z-10 mt-[28px] w-[342px] text-center font-heading text-[44px] font-medium leading-[48px] text-white md:absolute md:w-[702px] md:text-[80px] md:leading-[95px]'>
        Welcome to VDAO
      </div>

      <Image src={MainHero} alt='VDAO Web3 Hero' className='hidden h-[780px] w-full object-cover md:block lg:object-contain' />
      <Image src={MainHeroForMobile} alt='VDAO Web3 Hero' className=' relative top-[-23px] mb-[22px] h-[316px] w-full md:hidden' />
    </Section>
  )
}
