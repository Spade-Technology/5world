    ...
    <CustomModal show={show} close={close} heading="Create Grants">
      <div className="pt-10 pb-[24px] font-body text-lg font-normal md:pt-[60px]">
        ...
        <div className="mt-10">
          ...
          <div className="mt-5 rounded-[10px] md:p-10 md:pr-[94px] py-[30px] px-5 outline">
            ...
            MANA-A Vaults, as detailed below. Voting for this executive proposal
            will place your MKR in support of the changes and additions outlined
            above.
          </div>
        </div>
