  ...
  return (
    <div className="rounded-[20px] bg-white">
      ...
      <div className="px-[50px] py-10">
        <div className="font-heading text-[30px] font-medium">
          {details.title}
        </div>
        ...
        <div className="flex justify-between">
          ...
          <div className="my-auto text-lg font-bold">
            Last Update: {details.lastUpdated}
          </div>
        </div>

        <div className="pt-[30px] text-lg font-normal">
          {details.description}
        </div>
        ...
        <div className="flex gap-[10px] pt-[18px] pb-[14px]">
          <WhiteButton
            text="60"
            className="border-[1px] border-vdao-dark py-[5px] font-heading text-xl"
          />
