...
export function ProposalComponent() {
  ...
  return (
    <div className="mt-28 pb-28">
      <div className="clash pb-9 text-[26px] font-medium text-white md:pb-10 md:text-3xl">
        Proposals Insights
      </div>
        ...
        {[
          ...
          return (
            <div className="flex w-full flex-col gap-5 rounded-2xl bg-vdao-dark px-[30px] py-5 pt-5 md:w-[23%] md:px-7 md:pb-10">
              ...
              <div className="satoshi text-[32px] font-bold leading-8 text-vdao-light">
                {amount}
              </div>
            </div>
          );
        ...
        <article className="mt-5 flex w-full flex-col rounded-2xl bg-vdao-dark px-[30px] py-5 pt-5 md:px-7 md:pb-10">
          ...
          <Section className="mt-10 flex flex-col gap-2.5">
            <div className="grid grid-cols-12 justify-between ">
              ...
              <div className="satoshi hidden text-sm font-normal text-white md:col-span-2 md:block">
                {"Start Date"}
              </div>
              <div className="satoshi hidden text-sm font-normal text-white md:col-span-2 md:block">
                {"End Date"}
              </div>
              <div className="satoshi hidden text-sm font-normal text-white md:col-span-1 md:block">
                {"Votes"}
              </div>
              <div className="satoshi hidden text-sm font-normal text-white md:col-span-1 md:block">
                {"Acceptance"}
              ...
              (
                ...
                return (
                  <div key={index} className=" grid grid-cols-12">
                    <div className="satoshi col-span-7 text-sm font-bold text-white md:col-span-5">
                      {proposal}
                    </div>
                    <div className="satoshi hidden text-sm font-bold text-white md:col-span-2 md:block">
                      {startDate}
                    </div>
                    <div className="satoshi hidden text-sm font-bold text-white md:col-span-2 md:block">
                      {endDate}
                    </div>
                    <div className="satoshi hidden text-sm font-bold text-white md:col-span-1 md:block">
                      {votes}
                    </div>
                    <div className="satoshi hidden text-sm font-bold text-white md:col-span-1 md:block">
                      {acceptance}
          ...
          return (
            <div className="mt-5 flex w-full flex-col rounded-2xl bg-vdao-dark px-7 pt-5 pb-10 md:w-[48.5%]">
              <div className="flex items-center justify-between">
                <div className="satoshi text-lg font-bold leading-[22px] text-white">
                  {title}
                </div>
        ...
        <article className="mt-5 flex w-full flex-col rounded-2xl bg-vdao-dark px-7 pt-5 pb-10 md:w-[75%]">
          ...
          <Section className="mt-10 flex flex-col gap-2.5">
            <div className="grid grid-cols-12 justify-between ">
              ...
              <div className="satoshi col-span-4 text-sm font-normal text-white md:col-span-2">
                {"Symbol"}
              </div>
              <div className="satoshi col-span-4 text-sm font-normal text-white md:col-span-2">
                {"Balance"}
              ...
              ({ token, symbol, balance, usdValue, percentage }, index) => {
                return (
                  <div key={index} className="justify- grid grid-cols-12 ">
                    <div className="satoshi col-span-4 text-sm font-bold text-white md:col-span-3">
                      {token}
                    </div>
                    <div className="satoshi col-span-4 text-sm font-bold text-white md:col-span-2">
                      {symbol}
                    </div>
                    <div className="satoshi col-span-4 text-sm font-bold text-white md:col-span-2">
                      {balance}
...
export function TitleComponent() {
  return (
    <div className="clash pb-10 text-[44px] font-medium text-vdao-light md:pt-20 md:pb-28 md:text-7xl">
      Analytics
    </div>
  );
}
