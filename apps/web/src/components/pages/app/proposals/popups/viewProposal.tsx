      ...
      <div className='pb-[30px] font-body text-lg font-normal text-vdao-dark'>
        ...
        <div className='grid grid-cols-1 gap-[73px] py-[10px] md:grid-cols-3 md:py-5'>
          <div className='col-span-2'>
            <div className='font-heading text-[26px] font-medium md:text-[30px]'>
              Proposal name goes here. One or two sentence will be ideal for this section
            </div>
            ...
            <div className='flex gap-[10px] border-b-[1px] border-b-vdao-dark pb-2 pt-10 font-body font-bold'>
              <div
                className={` ${!showComments && 'text-vdao-light'} cursor-pointer justify-start`}
...
const Detailed = () => {
  return (
    <div className='pt-11 text-black'>
      ...
      executive proposal into the voting system. MKR Holders should vote for this proposal if they support the following
      alterations to the Maker Protocol.
      <br />
      <br />
      If you are new to voting in the Maker Protocol, please see the voting guide to learn how voting works, and this
      wallet setup guide to set up your wallet to vote.
      <br />
      <br />
      Executive Summary
      <br />
      ...
      <br />
      <br />
      Unless otherwise noted, the changes and additions listed above are subject to the GSM Pause Delay. This means that
      if this executive proposal passes, the changes and additions listed above will only become active in the Maker
      Protocol after the GSM Pause Delay has expired. The GSM Pause Delay is currently set to 48 hours.
      <br />
      <br />
      If this executive proposal does not pass within 30 days, then it will expire and can no longer have any effect on
      the Maker Protocol.
      <br />
      <br />
      ...
      out-of-schedule executive proposal passes. To read more on the process for urgent responses, please see MIP24:
      Emergency Response.
      <br />
      <br />
      MATIC-A Changes
      ...
      Review
      <br />
      Community debate on these topics can be found on the MakerDAO Governance forum. Please review any linked threads
      to inform your position before voting.
      <br />
      <br />
      Additionally, these changes may have been discussed further in recent Governance calls. Video for these calls is
      available to review.
      <br />
      <br />
      Resources
      <br />
      Additional information about the Governance process can be found in the Governance section of the MakerDAO
      community portal.
      <br />
      <br />
