      ...
      <div className=' mx-auto grid max-w-[1280px] grid-cols-1 md:grid-cols-3 md:gap-[68px]'>
        ...
        <div className='col-span-2 max-w-[669px] pt-11 font-body text-[22px] font-normal text-white md:pt-0'>
          ...
          <div id='codeOfConduct'>
            ...
            <div className='pt-5'>
              We are committed to fostering an a-political environment that is creative, hospitable and collaborative.
              We encourage all those who participate in the DAO to actively contribute to building a community that
              offers positive experiences for everyone, regardless of their views, background or identity.
            </div>
          </div>
          ...
          <div className='pt-[60px]' id='goal'>
            ...
            <div className='pt-5'>
              The goal of this Code of Conduct is to set the overall tone for our community and to provide a guide and a
              process by which we interact and hold each other accountable. This isn't an exhaustive list of things you
              can and can't do. Rather its an invitation to community members to reflect upon how they can help to
              support a thriving, healthy community space. The following values and ethics guide our thinking:
            ...
            <div className='pt-5'>
              ...
              <ul className='list-disc p-5 pl-10'>
                ...
                <li>
                  Being kind and courteous to others. Exercising consideration and respect in your speech and actions.
                </li>
            ...
            <div className='pt-5'>
              ...
              <ul className='list-disc p-5 pl-10'>
                <li>
                  Overt political or ideological discourse that seeks to divide the community in to ‘us’ and ‘them’.
                </li>
                <li>Implicitly or explicitly offensive comments, harassment or trolling.</li>
                <li>
                  Use of sexual images or messages, the use of explicit or violent sexual language and unwelcome sexual
                  advances.
                </li>
                <li>
                  Threats or incitement of violence of any kind, including encouraging an individual to engage in
                  self-harm.
                </li>
          ...
          <div className='pt-[60px]' id='scope'>
            ...
            <div className='pt-5'>
              This Code of Conduct applies to all spaces managed, facilitated and maintained by the DAO both online and
              in real life. It also applies when an individual is representing the project or its community in public
              spaces or online spaces outwith the DAO.
            </div>
          </div>
          ...
          <div className='pt-[60px]' id='enforcement'>
            ...
            <div className='pt-5'>
              Users who wish to report an issue can email X@5thworld.farms. Guild stewards will review the submission as
              promptly as possible and address the issue to the best of their abilities.
            </div>
          </div>
          ...
          <div className='pt-[60px]' id='enf-guidelines'>
            ...
            <div className='pt-5'>
              Community stewards will follow these Community Impact Guidelines in determining the consequences for any
            ...
            <div className='pt-[52px]'>
              <div className='pt-5'>
                ...
                the community.
                <br />
                Consequence: A private, written warning from Guild stewards, providing clarity around the nature of the
              ...
              <div className='pt-5'>
                ...
                a specified period of time. No public or private interaction with the people involved, including
