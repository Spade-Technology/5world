    ...
    <div className="bg-vdao-deep ">
      <div className="mx-auto flex max-w-[1280px] flex-col  justify-between gap-11 px-6 py-16 font-body text-white md:flex-row md:gap-10 md:py-24 md:px-24 ">
        <div className="flex-1">
          <div className="font-heading text-4xl text-vdao-light md:text-5xl">
            Funding Schedule
          </div>
          <div className="mt-8 font-heading text-2xl md:mt-12 md:text-3xl">
            Grants Round 1
          </div>
          <div className="pt-3 text-xl md:pt-6 md:text-2xl">
        ...
        <div className="flex-1">
          ...
          <div className="pt-5 text-2xl font-light md:pt-6">
            ...
            <a
              href=""
              target="_blank"
              className="border-b-2 font-semibold text-white"
            >
          ...
          <div className="pt-6 text-lg font-light">
            For additional information please contact us @vdao_regen on Twitter
