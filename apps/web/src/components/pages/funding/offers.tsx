...
const Offers = () => {
  ...
  return (
    <div className='mx-auto max-w-[1280px] py-5 px-6 md:py-36 md:px-0 '>
      <div className='font-heading text-3xl md:text-center md:text-5xl'>What’s on Offer?</div>
        ...
        {offersInfo.map((offer, idx) => {
          return (
            <div className='flex-1' key={idx}>
              ...
              <div className='mx-auto w-full pt-5 text-center text-lg'>{offer.content}</div>
            </div>
          )
        })}
      </div>
