    ...
    <section className="my-36 flex flex-col overflow-hidden py-24 px-6 text-vdao-dark md:flex-row md:px-0">
      <div className="mx-auto flex w-full max-w-[1280px] flex-col gap-20">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="mr-auto w-full text-lg">
            <div className="max-w-[410px]">
              Traditional industrial/chemical agricultural systems have reached
              the limits of what they can offer us without damaging the
              eco-systems we all depend upon. Our need for viable alternatives
              has never been more clear.
              <br />
              <br />
              VDAO is a novel Web3 coordination platform where individuals,
              institutions and skilled professionals can come together to fund
              regenerative agriculture R&D, creating a decentralised,
          ...
          <div className="grid w-full grid-cols-1 grid-rows-4 gap-4 md:grid-cols-2 md:grid-rows-2  md:gap-10">
            <div className="flex max-w-[340px] flex-col gap-4">
              ...
              <span className="text-lg font-normal">
                ...
                Pellentesque eget eleifend nisi. Vestibulum euismod, augue at
                tempor.
              </span>
            </div>
            <div className="flex max-w-[340px] flex-col gap-4">
              ...
              <span className="text-lg font-normal">
                ...
                <br />
                <br />
                Healthy community relations are supported via our comprehensive
                Code of Conduct.
              </span>
            </div>
            <div className="flex max-w-[340px] flex-col gap-4">
