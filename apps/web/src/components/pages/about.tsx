  ...
  return (
    <Section className='xl:px-O mx-auto my-36 flex max-w-[1280px] flex-col px-6 md:px-12'>
      <div className='flex w-full flex-col md:flex-row'>
        <h1 className='mb-6 w-full text-left text-4xl font-medium md:text-5xl'>Our Core Team</h1>
        ...
        <div className='flex w-full justify-center'>
          <div className='grid grid-cols-1 gap-16 md:grid-cols-3 xl:grid-cols-5'>
            <div className='flex flex-col'>
              ...
              <h1 className='mt-5 font-body text-2xl font-medium text-vdao-dark'>Full Name</h1>
              <h1 className=' mt-2 font-body text-xl font-normal text-vdao-dark'>Title</h1>
            </div>
            <div className='flex flex-col'>
              <div className='h-72 w-72 bg-vdao-lightpurple  opacity-70'></div>
              <h1 className='mt-5 font-body text-2xl font-medium text-vdao-dark'>Full Name</h1>
      ...
      <div className='mx-auto mt-20 flex w-full'>
        <h1 className='mb-6 w-full text-left text-5xl font-medium'>Guardians</h1>
      </div>
      <div className='flex'>
        <div className='flex w-full justify-center'>
          <div className='grid grid-cols-1 gap-16 md:grid-cols-3 xl:grid-cols-5'>
    ...
    <Section className='xl:px-O my-36 flex flex-col overflow-hidden  py-24 px-6 text-vdao-dark md:flex-row md:px-12'>
      <div className='mx-auto flex w-full max-w-[1280px] flex-col gap-20'>
        <div className='flex flex-col md:flex-row'>
          <h1 className='mb-6 w-full text-4xl font-medium underline md:text-center md:text-5xl'>Vision</h1>
        ...
        <div className='flex flex-col md:flex-row'>
          <h1 className='mb-6 w-full text-4xl font-medium underline md:text-center md:text-5xl'>Mission</h1>
          <div className='mr-auto w-full text-lg'>
            <div className='max-w-[410px]'>
    ...
    <Section className='xl:px-O my-36 bg-vdao-deep py-24  px-6 text-vdao-light md:px-12 xl:overflow-hidden'>
      <div className='mx-auto flex max-w-[1440px] flex-col '>
        <div className='mx-auto w-full max-w-[1280px] '>
          <h1 className='mb-6 w-full text-left text-4xl font-medium md:text-5xl'>Our Core Value</h1>
        </div>
...
export function AboutUsComponent() {
  return (
    <Section className='xl:px-O my-16 flex w-full max-w-[1280px] flex-col px-6 md:mx-auto md:px-12 '>
      <h1 className='mb-6 text-left text-4xl font-medium md:w-1/2 md:text-8xl'>About Us</h1>
