...
const Card = (props: CardProps) => {
  return (
    ...
    >
      ...
      <div className="mt-5 flex-1 text-xl text-white md:pr-10 md:text-2xl">
        {props.description}
      </div>
    ...
    <div className="flex flex-col md:flex-row">
      ...
      <div className="mx-10 mt-20 flex-1 md:mr-20">
        <Card
          ...
          description="Want to learn more? Head over to our discord channel to meet our DAO community and explore how you might be able to contribute."
        />
        <Card
          buttonText="Apply Now"
          description="Ready to jump in and help out? Complete our membership application form by clicking below."
          className="mt-14"
        />
      </div>
    </div>
