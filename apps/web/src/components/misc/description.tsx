...
const Description = (props: Props) => {
  ...
  return (
    <div className={`${containerClass} mx-auto flex max-w-[1320px] flex-col  justify-center px-0 md:flex-row md:gap-[54px] md:px-6 ${props.invertColors ? 'bg-vdao-deep text-white' : ''}`}>
