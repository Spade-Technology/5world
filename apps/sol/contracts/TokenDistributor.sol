...
contract TokenDistributor{ 
    ...
    address immutable public vToken; 
    ...
    bytes32 constant DAO_TOKEN_CLAIM_TYPEHASH = keccak256(
     ...
     **/
    constructor(address _vToken, address _signer, address _treasury, bytes32 _merkleRoot) {
        signer = _signer;
        vToken = _vToken;
    ...
    **/
    function claimTokens(
        ...
        require(IERC20(vToken).transfer(user_address, user_amount), 'TokenDistributor: Transfer failed.');
    ...
    **/
    function transferUnclaimed() public {
        ...
        require(IERC20(vToken).transfer(treasury, remainingBalance), 'TokenDistributor: Transfer unclaimed failed.');
