...
contract VDaoToken {
    ...
    /// @notice An event thats emitted when the distributor address is changed
    ...
    /// @notice An event that emitted when account is whitelisted
    event WhitelistUpdated(address indexed account, bool whitelisted);

    /**
     * @notice Construct a new V token
     * @param account The initial account to grant all the tokens
     * @param timelock_ the token distributor address
     */
    constructor(address account, address timelock_) {
    ...
    /**
     * @notice Change the timelock address
    ...
    /**
     * @notice Change the whitelisted status of an account
     * @param account_ The address of the account to be whitelisted
    ...
    /**
     * @notice Change the whitelisted status of multiple accounts
    ...
    function approve(address spender, uint rawAmount) external returns (bool) {
        ...
        if (rawAmount == type(uint).max) {
            ...
            amount = safe96(rawAmount, "V::approve: amount exceeds 96 bits");
        }
    ...
    function permit(
        ...
        require(block.timestamp <= deadline, "V::permit: signature expired");
    ...
    /**
     * @notice Get the whitelist status of the `account`
     * @param account The address of the account to get the status
